...
class Transaction(object):
    def __init__(self, sender_private_key, sender_public_key, sender_blockchain_address, receipient_blockchain_address, value):
        self.sender_private_key = sender_private_key
        self.sender_public_key = sender_public_key
        self.sender_blockchain_address = sender_blockchain_address
        self.receipient_blockchain_address = receipient_blockchain_address
        self.value = value
    ...
    def generate_signature(self):
        ...
        transaction = utils.sorted_dict_by_key({
            ...
            'receipient_blockchain_address': self.receipient_blockchain_address,
